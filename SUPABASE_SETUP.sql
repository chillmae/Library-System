...
ALTER TABLE IF EXISTS users ADD COLUMN IF NOT EXISTS organization VARCHAR(100);
...
('2026-06-13 14:00:00+00', 'Reading and research workshop for senior students', 'Library Staff, Senior High Representatives', 'Planned');
